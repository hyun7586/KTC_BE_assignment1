...
public class AppLv3 {
  ...
  public static void main(String[] args) {
    ...
    ArithmeticCalculatorLv3<Double> arithmeticCalculatorLv3 = new ArithmeticCalculatorLv3<>();
    ...
    while (!command.equals("exit")) {
      ...
      Optional<Double> result = arithmeticCalculatorLv3.calculate(operand1, operand2, operator);
      if (result.isPresent()) {
        arithmeticCalculatorLv3.getResultList().add(result.get());
      }
      ...
      if (command.equals("remove")) {
        ...
        List<Double> list = arithmeticCalculatorLv3.getResultList();
        ...
        List<Double> list = arithmeticCalculatorLv3.getResultList().stream()
            .filter(x -> (x > target))
            .toList();
